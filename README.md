...
Semantic HTML is giving meaning to the information on webpages.

2. Name two big differences between ```display: block;``` and ```display: inline;```.

The main difference between display:block and display:inline is that display:block allows to set width and height on the element.
...
It offers performance, functionality, security and flexibility that developers and teams need to develop their projects
